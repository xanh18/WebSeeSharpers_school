...
using WebSeeSharpers.Services.SeatService.Extensions;
...
public class SeatService
{
    ...
    public SeatService(Viewing viewing, WebSeeSharpersContext context)
    {
        _viewing = viewing;
    ...
    {
        return _context.ViewingSeats.Where(s => s.Viewing.Id == _viewing.Id).ToList();
    }
